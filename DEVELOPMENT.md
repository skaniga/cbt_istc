...
```bash
git remote add encore encore://computer-service-shop-o2k2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/computer-service-shop-o2k2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/computer-service-shop-o2k2/settings/integrations/github)
