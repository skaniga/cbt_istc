...
import { list as api_cart_list_list } from "~backend/cart/list";
...
export namespace cart {
    ...
    export class ServiceClient {
         ...
         */
        public async list(): Promise<ResponseType<typeof api_cart_list_list>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/cart`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_cart_list_list>
        }
 ...
 * Import the endpoint handlers to derive the types for the client.
 */
import { getCategories as api_product_categories_getCategories } from "~backend/product/categories";
...
export namespace product {
    ...
    export class ServiceClient {
         ...
         */
        public async getCategories(): Promise<ResponseType<typeof api_product_categories_getCategories>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/products/categories`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_product_categories_getCategories>
        }
